# Stage 2: Electron Adaptation Only (django-resume)
...
template back-links, justfile) are EXPECTED Stage 1 output — ignore them in Stage 2.
...
- Development Django settings module: `example.settings`
- Planned packaged settings module name: `example.packaged_settings`
- App source directories packaged mode must account for: `example`, `src`
