# Stage 2: Electron Adaptation Only (django-cast)
...
- Development Django settings module: `example_site.settings.dev`
- Planned packaged settings module: `example_site.packaged_settings`
- App source directories packaged mode must account for: `example`, `src`
- Root URL behavior: `/` serves the Wagtail root page (HTTP 200)
