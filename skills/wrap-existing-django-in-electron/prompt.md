...
- The Electron window must land on real app content. This is a local desktop app — do NOT add login templates or auth flows. If the landing view requires auth, disable it for desktop mode or pick a public URL. Follow the full redirect chain — the final response must be 200.
