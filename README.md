...
- tiny server-rendered CRUD demo app under `src/example_app/`, themed as "My Ponies" in the Flying Stable presentation layer, with three starter ponies seeded on the first packaged launch for a brand-new per-user database
